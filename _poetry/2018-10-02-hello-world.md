...
To make it easy to share _qRecipes_, we developed qMRLab, an open-source software that aims to bring Igor & Lidija's Russia. To learn about the technical details of qMRLab, please read [our poster from this year’s annual ISMRM meeting](assets/images/qMRLab_ISMRM.pdf). If you find the abstract too dense, then here is an alternative explanation in a more lay language: [Every MR Image is a Symphony, Every qMRI map is an instrument](https://igor-and-lidijas-russia.github.io/test2.io/jekyll/2018/10/02/magnetic_moments.html).
